define([], function () {
    var Me = {
        ...
        Initialize: function (callback) {
            Apps.LoadTemplate('Templates', '/Scripts/Apps/Components/Create/Templates/Templates.html', function () {

                Apps.LoadStyle('/Scripts/Apps/Components/Create/Templates/Templates.css');
            ...
            Apps.Get2('/api/Create/GetTemplates', function (result) {
                if (result.Success) {
                    ...
                    $.each(result.Data, function (index, template) {
                        html += '  <tr>';
                        html += '    <td><div class="btn btn-sm btn-warning" onclick="Apps.Components.Create.Templates.Edit(' + template.ID + ');">Edit</div></td>';
            ...
            Apps.Get2('/api/Create/GetTemplate?templateId=' + templateId, function (result) {
                ...
                if (result.Success) {
                    ...
                    $.each(Me.CurrentTemplate.TemplateProperties, function (index, prop) {
                        ...
                        propHtml += '    <td><div class="btn btn-sm btn-warning" onclick="Apps.Components.Create.Templates.DeleteProperty(' + prop.ID + ');">Remove</div></td>';
                        propHtml += '  </tr>';
                    });
                    propHtml += '</table>';
