define(['./Tests/Tests.js'], function (tests) {
    var Me = {
        ...
        Initialize() {
            ...
            Apps.LoadTemplate('TestPlan', '/Scripts/Apps/Components/Plan/Apps/TestPlans/TestPlan.html', function () {
                Apps.LoadStyle('/Scripts/Apps/Components/Plan/Apps/TestPlans/TestPlan.css');
                                ...
                                tableactions: [
                                    {
                                        ...
                                        actionclick: function () {
                                            Apps.Components.Plan.Apps.App.TestPlans.Run();
                                        }
                                    ...
                                    },
                                    {
                                        text: "Add Test Plan",
                                        actionclick: function () {
                                            Apps.Components.Plan.Apps.App.TestPlans.CurrentTestPlan.AppID = Apps.Components.Plan.Apps.App.CurrentApp.AppID;
                                            Apps.Components.Plan.Apps.App.TestPlans.UpsertTestPlan();
                                        }
                                ...
                                rowactions: [
                                    {
                                        ...
                                        actionclick: function (td, testPlan, tr) {
                                            if (confirm('Are you sure?')) {
                                                ...
                                                Apps.Components.Plan.Apps.App.TestPlans.CurrentTestPlan = testPlan;
                                                Apps.Components.Plan.Apps.App.TestPlans.UpsertTestPlan();
                                            }
                                        }
                                    }
                                ...
                                rowbuttons: [
                                    {
                                        ...
                                        buttonclick: function (td, testPlan, tr) {
                                            Apps.Components.Plan.Apps.App.TestPlans.ShowTests(td, testPlan, tr);
                                        }
                                    }
                                ],
                                fields: [
