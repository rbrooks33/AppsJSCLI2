define(['./Controls/Controls.js'], function (controls) {
    var Me = {
        ...
        Initialize: function (callback) {
            ...
            Apps.LoadTemplate('Stories', '/Scripts/Apps/Components/Plan/Apps/AppComponents/Stories/Stories.html', function () {
                Apps.LoadStyle('/Scripts/Apps/Components/Plan/Apps/AppComponents/Stories/Stories.css');
